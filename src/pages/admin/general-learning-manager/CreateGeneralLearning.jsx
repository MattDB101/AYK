...
function CreateGeneralLearning() {
  ...
  const { addGeneralLearning, loading, error } = useGeneralLearningManager();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await addGeneralLearning(formData, imageFile, slides, allContent);
      alert('General Learning Resource created successfully!');
      navigate('/admin');
    } catch (error) {
    ...
    <div className={styles.container}>
      <div className={styles.header}>
        <div className={styles.headerLeft}>
          ...
          <h1>Add New General Learning Resource</h1>
        </div>
      </div>
...
export default CreateGeneralLearning;
